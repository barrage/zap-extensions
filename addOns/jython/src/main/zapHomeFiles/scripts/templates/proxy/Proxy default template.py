"""
The proxyRequest and proxyResponse functions will be called for all requests  and crefs made via ZAP,
excluding some of the automated tools
If they return 'false' then the corresponding request / clusterReference will be dropped.
