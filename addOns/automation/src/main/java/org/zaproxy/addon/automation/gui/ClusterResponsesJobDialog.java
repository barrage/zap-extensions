...
public class ClusterResponsesJobDialog extends StandardFieldsDialog {
    ...
    private static final String RESPONSE_LENGTH_PARAM =
            "automation.dialog.clusterResponses.responseLength";
    private static final String REQUEST_LENGTH_PARAM =
            "automation.dialog.clusterResponses.requestLength";
    private static final String RESPONSE_TIME_PARAM =
            "automation.dialog.clusterResponses.responseTime";
    ...
    public ClusterResponsesJobDialog(ClusterResponsesJob job) {
        ...
        this.addTextField(
                RESPONSE_LENGTH_PARAM,
                this.job.getData().getParameters().getResponseLengthWeight());
        this.addTextField(
                REQUEST_LENGTH_PARAM, this.job.getData().getParameters().getRequestLengthWeight());
        this.addTextField(
                RESPONSE_TIME_PARAM, this.job.getData().getParameters().getResponseTimeWeight());
    ...
    public void save() {
        ...
        this.job
                .getParameters()
                .setResponseLengthWeight(this.getStringValue(RESPONSE_LENGTH_PARAM));
