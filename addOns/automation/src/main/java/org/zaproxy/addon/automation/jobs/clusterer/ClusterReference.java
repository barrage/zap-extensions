...
import static org.zaproxy.addon.automation.jobs.clusterer.Clusterer.maxValues;
...
public class ClusterReference {
    ...
    // used for generating centroids or averages for clustering purposes, doesn't contain a
    // HistoryReference of an actual request/response
    public ClusterReference(Map<String, Double> fields, String responseBody) {
        ...
        this.rawRequest =
                String.format(
                        "responseLength:%d, requestLength:%d, Reflected:%d",
                        responseLength, requestLength, reflected);
    }
    ...
    public ClusterReference(
            ...
            int responseTime,
            String responseBody,
            ClusterReference maxValues) {
        this(
                href.getResponseBodyLength(),
    ...
    public ClusterReference(
        ...
        this.rawRequest =
                String.format(
                        "responseLength:%d, PayloadLength:%d, Reflected:%d",
                        responseLength, requestLength, reflected);
    }
    ...
    public boolean equals(Object o) {
        ...
        return responseLength == that.responseLength
                && requestLength == that.requestLength
    ...
    public String toString() {
        boolean debug = false;
        String s =
                historyReference == null ? "null" : String.valueOf(historyReference.getHistoryId());
        if (!debug) {
