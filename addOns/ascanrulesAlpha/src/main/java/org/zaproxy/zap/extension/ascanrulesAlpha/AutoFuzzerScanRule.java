...
/**
 * Active scan rule that fuzzes all given parameters using user payloads passed through Radamsa
 * fuzzer.
 */
public class AutoFuzzerScanRule extends AbstractAppParamPlugin {
    ...
    private static final Logger log = LogManager.getLogger(AutoFuzzerScanRule.class);
    ...
    public void scan(HttpMessage msg, String param, String value) {
        try {
            ...
            log.error(
                    "Error in config file /ZAP home/fuzzers/autofuzzer.config, view documentation");
        }
        try {
    ...
    private static void generatePayloads(String userPayload, int quantity, String outputName)
            throws Exception {
